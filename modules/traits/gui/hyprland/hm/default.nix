    ...
    home.packages = with pkgs; [
      (pkgs.writeShellApplication {
        ...
        text = ''
          ...
          if [[ "$CUR" == *"101010" ]]; then
            hyprctl keyword monitor "$MON,highrr,auto,1,bitdepth,8"
          else
            hyprctl keyword monitor "$MON,highrr,auto,1,bitdepth,10"
          fi
        '';
      })
      hyprpolkitagent
    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        monitor = [
          ...
          "desc:Dell Inc. DELL U3818DW 5KC0386E05KL, highrr, auto, auto, bitdepth, 10"
          "desc:Chimei Innolux Corporation 0x14D4, highrr, auto, 1"
          "desc:XXX Beyond TV 0x00010000, highrr, auto, 1.5, bitdepth, 10"
        ];
